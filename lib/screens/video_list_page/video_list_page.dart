...
import 'package:youtube_clone/commons/comments_bottom_sheet.dart';
                    ...
                    children: [
                      CircleAvatar(
                        backgroundImage: AssetImage(
                            'assets/images/video_player_page_images/pp.jpeg'),
                        radius: 20,
                      ),
                      SizedBox(width: 10),
                      Expanded(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            fontSize: 17,
                            color: Color(0xFFFFFFFF)), // Share metni rengi
                      ),
                      IconButton(
                        onPressed: () {
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            fontSize: 17,
                            color: Color(0xFFFFFFFF)), // Download metni rengi
                      ),
                    ],
                  ),
                  SizedBox(height: 20),
                    ...
                    onPressed: () {
                      ...
                      showModalBottomSheet<void>(
                        ...
                        builder: (BuildContext context) {
                          return commentsBottomSheet(context);
                        },
                      );
                    },
